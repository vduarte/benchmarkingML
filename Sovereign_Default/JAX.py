import jax.numpy as np, time, jax, numpy

logy_grid = numpy.loadtxt('logy_grid.txt')
Py = numpy.loadtxt('P.txt')


def main(nB, repeats=500):
    β = .953
    γ = 2.
    r = 0.017
    θ = 0.282
...
print(1000 * main(nB=551, repeats=500))
